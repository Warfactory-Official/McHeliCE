...
public class TxtParser implements IParser {
            ...
            if (s.length >= 3) {
                ...
                item.equalsIgnoreCase("AddSteeringSearchLight")) {
                    ...
                    if (s.length >= 7) {
                        ...
                        info.searchLights
                                .add(new SearchLight(info, v, cs, ce, h, w, fixDir, yaw, pitch, steering, stRot));
                    }
                } else
            if (item.equalsIgnoreCase("AddPartLightHatch")) {
                ...
                if (item.equalsIgnoreCase("SetWheelPos")) {
                    ...
                    if (item.equalsIgnoreCase("AddPartWeaponChild")) {
                        ...
                        info.soundMove = SoundRegistry.INSTANCE.parseSound(data);
                    ...
                    } else if (item.equalsIgnoreCase("AddPartWeaponBay") ||
                            item.equalsIgnoreCase("AddPartSlideWeaponBay")) {
                                boolean slide = item.equalsIgnoreCase("AddPartSlideWeaponBay");
                                String[] sx = data.split("\\s*,\\s*");
                                MCH_AircraftInfo.WeaponBay n;
                                if (slide) {
                                    if (sx.length >= 4) {
                                        n = new WeaponBay(info, sx[0].trim().toLowerCase(), info.toFloat(sx[1]),
                                    ...
                                    n = new WeaponBay(info, sx[0].trim().toLowerCase(), info.toFloat(sx[1]),
                                            ...
                                            "wb" + info.partWeaponBay.size(), false);
                                    info.partWeaponBay.add(n);
                                }
                            } else
                        if (item.compareTo("addparthatch") == 0 || item.compareTo("addpartslidehatch") == 0) {
                            ...
                            if (slide) {
                                if (sx.length >= 3) {
                                    n = new Hatch(info, info.toFloat(sx[0]), info.toFloat(sx[1]), info.toFloat(sx[2]),
                            ...
                            if (item.equalsIgnoreCase("AddPartThrottle")) {
                                ...
                                if (sxxx.length >= 7) {
                                    ...
                                    MCH_AircraftInfo.RotPart c = new RotPart(info, info.toFloat(sxxx[0]),
                                            info.toFloat(sxxx[1]), info.toFloat(sxxx[2]), info.toFloat(sxxx[3]),
                                            info.toFloat(sxxx[4]), info.toFloat(sxxx[5]), info.toFloat(sxxx[6]), always,
                                ...
                                if (sxxx.length >= 7) {
                                    info.partSteeringWheel.add(new PartWheel(info, info.toFloat(sxxx[0]),
                                            info.toFloat(sxxx[1]), info.toFloat(sxxx[2]), info.toFloat(
                                                    sxxx[3]),
                                            info.toFloat(sxxx[4]), info.toFloat(sxxx[5]), info.toFloat(sxxx[6]),
                                            "steering_wheel" +
                                ...
                                if (sxxx.length >= 5) {
                                    ...
                                    info.markerWidth = (float) Math.max(info.markerWidth,
                                            Math.abs(c.getBoundingBox().maxX) / 2.0);
                                    info.markerWidth = (float) Math.max(info.markerWidth,
                                            Math.abs(c.getBoundingBox().minX) / 2.0);
                                    info.markerWidth = (float) Math.max(info.markerWidth,
                                            Math.abs(c.getBoundingBox().maxZ) / 2.0);
                                    info.markerWidth = (float) Math.max(info.markerWidth,
                                            Math.abs(c.getBoundingBox().minZ) / 2.0);
    ...
    private void applyWeaponLine(MCH_WeaponInfo info, int lineNumber, String item, String data) {
        if (item.compareTo("displayname") == 0) {
            ...
            info.fireSound = SoundRegistry.INSTANCE.parseSound(data);
            ...
            if (item.compareTo("soundvolume") == 0) {
            ...
            } else if (item.equalsIgnoreCase("BulletColorInWater") || item.equalsIgnoreCase("BulletColor") ||
                    item.equalsIgnoreCase("SmokeColor")) {
                        String[] sx = data.split("\\s*,\\s*");
                        if (sx.length >= 4) {
                ...
                if (item.equalsIgnoreCase("nukeYield")) {
                    ...
                    info.weaponSwitchSound = SoundRegistry.INSTANCE.parseSound(data);
