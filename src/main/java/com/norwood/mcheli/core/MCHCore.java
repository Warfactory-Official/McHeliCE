...
public class MCHCore implements IFMLLoadingPlugin {
    ...
    public String[] getASMTransformerClass() {
        return new String[] {RenderGlobalTransformer.class.getName(), EntityRenderHooks.class.getName(), AviatorCodeGeneratorTransformer.class.getName()  /*,EntityTrackerEntryTransformer.class.getName(), EntityUnloadTransformer.class.getName(), EntityRendererTransformer.class.getName()*/  };
    }
